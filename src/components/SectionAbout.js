    ...
    <div className="container--section container--section-about">
      <div className="container">
        ...
        <div className="container--content">
          <h2 className="header--title text-5xl pb-5">Hi There,</h2>
          ...
          <p className="description">
            ...
            popular front-end frameworks such as React and Vue. I am passionate
            ...
            and other front-end frameworks gives me a strong foundation to build
            upon.
          </p>
        </div>
      </div>
