        ...
        <div className="container">
          <div className="container--content m-auto text-center">
            <h2 className="text-3xl mb-2 md:text-4xl">
              Transforming visions into compelling user interfaces -{" "}
              <PrimaryText text="Front-end Developer" /> with a
              passion for creating seamless web experiences.
            </h2>
            <p className="max-w-4xl mx-auto pt-7 pb-4">
              I am a skilled and dedicated developer with over{" "}
              <span className="primary-text font-bold">2+ years</span> of
